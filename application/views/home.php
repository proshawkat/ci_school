		...
		<div class="container">
			<div class="quatation-img-area">
				...
				<div class="row">
					<div class="col-md-2">
						<?php 
                            if(sizeof($total_pdt)>1){ ?>
							<div id="left_button" onclick="createUrl('<?php echo base_url();?><?php echo $next_r;?>')">
                        ...
                        <div class="col-md-10">
                            <form class="form-horizontal" action="<?php echo base_url() . "welcome/insert"; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="inputPassword3" name="price" class="col-sm-3 control-label" value="<?php echo set_value('price'); ?>">Price : <br /><small>(EXW)</small></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="model_num" class="form-control" id="" value="<?php echo set_value('model_num'); ?>" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="email" name="email" class="form-control" value="<?php echo set_value('email'); ?>" id="inputEmail3" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="phone" value="<?php echo set_value('phone'); ?>" class="form-control" id="" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="p_name" class="form-control" id="" value="<?php echo set_value('p_name'); ?>" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="c_name" class="form-control" id="" value="<?php echo set_value('c_name'); ?>" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="website" value="<?php echo set_value('website'); ?>" class="form-control" id="" >
